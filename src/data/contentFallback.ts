export const fallbackContent = {
  ...
  teachers: [
    { _id: 'teacher_zhang', name: '张老师', role: '医护方向主讲', tag: '十年教研经验', avatarUrl: 'https://picsum.photos/seed/teacher-zhang/400/400', avatarSeed: 'teacher-zhang', intro: '主带医护方向专业课，把知识框架和高频考点讲得更清楚。', specialties: ['医护专业课', '考点串讲', '阶段复盘'], sort: 10, status: 'published' },
    { _id: 'teacher_li', name: '李老师', role: '高数专项讲师', tag: '体系化提分', avatarUrl: 'https://picsum.photos/seed/teacher-li/400/400', avatarSeed: 'teacher-li', intro: '主带高数提分，从基础梳理到整卷训练都会拆开讲明白。', specialties: ['高数梳理', '题型突破', '冲刺训练'], sort: 20, status: 'published' },
    { _id: 'teacher_wang', name: '王老师', role: '公共课讲师', tag: '真题讲解', avatarUrl: 'https://picsum.photos/seed/teacher-wang/400/400', avatarSeed: 'teacher-wang', intro: '负责公共课讲解和真题方法归纳，适合用来补齐短板。', specialties: ['英语语法', '真题讲解', '方法归纳'], sort: 30, status: 'published' },
    { _id: 'teacher_zhao', name: '赵老师', role: '班主任督学', tag: '全程跟踪', avatarUrl: 'https://picsum.photos/seed/teacher-zhao/400/400', avatarSeed: 'teacher-zhao', intro: '负责班级节奏、答疑跟进和阶段提醒，帮你把执行落下去。', specialties: ['督学跟进', '打卡反馈', '节奏管理'], sort: 40, status: 'published' }
  ],
  successCases: [
    { _id: 'success_math_foundation_li', direction: 'math', pathTags: ['foundation', 'cross'], studentName: '李同学', studentAvatarText: '李', scoreGain: '+87分', scoreLabel: '高等数学', chips: ['跨专业', '零基础', '备考8个月'], startingLabel: '入学基础', startingScore: '首测 45分', finalLabel: '最终成绩', finalScore: '统考 132分', quote: '一开始连导数公式都背不全。真正的转折点在强化阶段，老师帮我把120种题型做了拆解，从死记硬背变成了看题找套路，做题速度和准确率瞬间上来了。', fitAudience: '数学基础几乎为零、跨专业、容易在综合大题上卡壳、需要从底层重构逻辑的同学。', listTitle: '基础薄弱怎么起步？先把知识链搭起来', listDesc: '适合数学基础几乎为零、跨专业，需要先把核心知识框架搭起来的同学。', detailButtonText: '获取 Ta 的同款备考规划', title: '基础薄弱怎么起步？先把知识链搭起来', subtitle: '适合数学基础几乎为零、跨专业，需要先把核心知识框架搭起来的同学。', coverUrl: '', coverSeed: 'success-math-li', year: 2025, category: '高数专项', sort: 10, status: 'published' },
    { _id: 'success_math_time_zhou', direction: 'math', pathTags: ['time'], studentName: '周同学', studentAvatarText: '周', scoreGain: '+42分', scoreLabel: '高等数学', chips: ['时间紧张', '备考3个月'], startingLabel: '入学基础', startingScore: '摸底 86分', finalLabel: '最终成绩', finalScore: '数学 128分', quote: '实习期在职备考，精准刷题比盲目海战更重要。把时间压在高频题型和模考复盘上之后，节奏一下就稳了。', fitAudience: '每天复习时间不足 3 小时、需要快速提分、时间利用必须非常精准的同学。', listTitle: '实习期在职备考，精准刷题比盲目海战更重要', listDesc: '适合时间紧张、备考窗口短、希望在有限时间里把高数分快速拉起来的同学。', detailButtonText: '看详情', title: '实习期在职备考，精准刷题比盲目海战更重要', subtitle: '适合时间紧张、备考窗口短、希望在有限时间里把高数分快速拉起来的同学。', coverUrl: '', coverSeed: 'success-math-zhou', year: 2024, category: '高数专项', sort: 20, status: 'published' },
    { _id: 'success_math_sprint_zhao', direction: 'math', pathTags: ['sprint'], studentName: '赵同学', studentAvatarText: '赵', scoreGain: '+31分', scoreLabel: '数学 128分', chips: ['冲刺逆袭', '备考2个月'], startingLabel: '入学基础', startingScore: '模考 97分', finalLabel: '最终成绩', finalScore: '统考 128分', quote: '考前疯狂掉分？全真模拟卷让我找回考场节奏，最后两个月最关键的是把答题顺序和时间分配练熟。', fitAudience: '知识点已过完，但做题慢、缺少临场经验、最后阶段想稳住成绩的同学。', listTitle: '考前疯狂掉分？全真模拟卷让我找回考场节奏', listDesc: '适合已经完成一轮复习、但模考不稳、冲刺阶段需要把节奏拉回来的同学。', detailButtonText: '看详情', title: '考前疯狂掉分？全真模拟卷让我找回考场节奏', subtitle: '适合已经完成一轮复习、但模考不稳、冲刺阶段需要把节奏拉回来的同学。', coverUrl: '', coverSeed: 'success-math-zhao', year: 2024, category: '高数专项', sort: 30, status: 'published' },
    { _id: 'success_medical_foundation_zhang', direction: 'medical', pathTags: ['foundation', 'cross'], studentName: '张同学', studentAvatarText: '张', scoreGain: '+86分', scoreLabel: '医护综合', chips: ['基础薄弱', '跨专业', '备考6个月'], startingLabel: '入学基础', startingScore: '首测 46分', finalLabel: '最终成绩', finalScore: '统考 132分', quote: '最开始我连护理和生理的重点都抓不住，真正的变化是先把主干知识和口诀记忆顺下来，再用章节同步题去巩固，后面成绩涨得特别快。', fitAudience: '专业基础薄弱、跨专业、医学名词记不住、需要先把主干知识体系建起来的同学。', listTitle: '基础薄弱先别急着刷题，先把主干知识顺下来', listDesc: '适合医护综合基础薄弱、跨专业、需要先把主干考点搭起来的同学。', detailButtonText: '获取 Ta 的同款备考规划', title: '基础薄弱先别急着刷题，先把主干知识顺下来', subtitle: '适合医护综合基础薄弱、跨专业、需要先把主干考点搭起来的同学。', coverUrl: '', coverSeed: 'success-medical-zhang', year: 2025, category: '医护综合', sort: 40, status: 'published' },
    { _id: 'success_medical_time_wang', direction: 'medical', pathTags: ['time'], studentName: '王同学', studentAvatarText: '王', scoreGain: '+39分', scoreLabel: '医护综合', chips: ['时间紧张', '备考4个月'], startingLabel: '入学基础', startingScore: '阶段测评 88分', finalLabel: '最终成绩', finalScore: '统考 127分', quote: '时间不够的时候不能什么都抓，老师帮我把高频章节和易错点先筛出来，后面复盘变得特别高效。', fitAudience: '时间有限、需要优先抓高频考点、希望在短时间内稳住医护综合成绩的同学。', listTitle: '时间不够时，先抓高频考点和易错点', listDesc: '适合复习时间紧、需要快速筛出高频考点、优先保住基础分的同学。', detailButtonText: '看详情', title: '时间不够时，先抓高频考点和易错点', subtitle: '适合复习时间紧、需要快速筛出高频考点、优先保住基础分的同学。', coverUrl: '', coverSeed: 'success-medical-wang', year: 2024, category: '医护综合', sort: 50, status: 'published' },
    { _id: 'success_medical_sprint_chen', direction: 'medical', pathTags: ['sprint'], studentName: '陈同学', studentAvatarText: '陈', scoreGain: '+28分', scoreLabel: '医护 126分', chips: ['冲刺逆袭', '备考2个月'], startingLabel: '入学基础', startingScore: '模考 98分', finalLabel: '最终成绩', finalScore: '统考 126分', quote: '冲刺阶段最怕节奏乱，整卷模考和考前速记册帮我把最容易丢分的地方重新压了一遍，最后成绩比想象中更稳。', fitAudience: '已经完成主干复习、考前节奏不稳、需要整卷模拟和重点压缩回看的同学。', listTitle: '冲刺阶段最怕节奏乱，整卷模考帮我稳住了', listDesc: '适合已经完成主干复习、需要在最后阶段把节奏和答题状态拉稳的同学。', detailButtonText: '看详情', title: '冲刺阶段最怕节奏乱，整卷模考帮我稳住了', subtitle: '适合已经完成主干复习、需要在最后阶段把节奏和答题状态拉稳的同学。', coverUrl: '', coverSeed: 'success-medical-chen', year: 2024, category: '医护综合', sort: 60, status: 'published' }
  ],
  materialPackages: [
