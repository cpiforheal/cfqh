const seedData = {
  ...
  successCases: [
    { _id: 'success_2025', title: '2025 护理方向上岸复盘', subtitle: '从基础薄弱到稳定提分，最后被目标本科录取。', coverSeed: 'success-2025', year: 2025, category: '医护方向', sort: 10, status: 'published' },
    { _id: 'success_2024', title: '2024 高数单科突破复盘', subtitle: '先补基础再做整卷训练，单科成绩明显提升。', coverSeed: 'success-2024', year: 2024, category: '高数专项', sort: 20, status: 'published' },
    { _id: 'success_2023', title: '2023 跨专业备考逆袭', subtitle: '时间紧也能按阶段推进，最终完成上岸目标。', coverSeed: 'success-2023', year: 2023, category: '跨考案例', sort: 30, status: 'published' }
  ],
  materialPackages: [
